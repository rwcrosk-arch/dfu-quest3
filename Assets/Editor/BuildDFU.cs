...
public class BuildDFU {
    ...
    public static void PrepAndroidSettings() {
        ...
        // Enable the Input System XR backend so OpenXR controller data surfaces through
        // Input System XRController (the correct Unity 6 + OpenXR input path). Legacy
        // InputDevices sees the devices but reads ZEROS on Unity 6 + OpenXR — reading via
