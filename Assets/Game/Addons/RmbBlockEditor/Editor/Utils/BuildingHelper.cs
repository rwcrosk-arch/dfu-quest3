...
namespace DaggerfallWorkshop.Game.Addons.RmbBlockEditor
{
    public static class BuildingHelper
    {
        ...
        {
            var tabs = new Tabs();
            var tab1 = new global::DaggerfallWorkshop.Game.Addons.RmbBlockEditor.Elements.Tab { value = 0, label = "Exterior" };
            var tab2 = new global::DaggerfallWorkshop.Game.Addons.RmbBlockEditor.Elements.Tab { value = 1, label = "Interior" };
